...
//                        }
        ...
        mContentView.findViewById(R.id.btn_start_client).setOnClickListener(
                new View.OnClickListener() {
                    ...
                    @Override
                    public void onClick(View v) {
                        EventBus.getDefault().post(new StartEvent("start"));
        ...
        mContentView.findViewById(R.id.btn_end_client).setOnClickListener(
                new View.OnClickListener() {

                    @Override
                    public void onClick(View v) {
                        EventBus.getDefault().post(new StopEvent("stop"));
    ...
    public void onConnectionInfoAvailable(final WifiP2pInfo info) {
        ...
        Log.e("fraginfo",info.groupOwnerAddress.getHostAddress());
